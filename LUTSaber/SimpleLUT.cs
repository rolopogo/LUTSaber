...
namespace DigitalRuby.SimpleLUT
{
    ...
    public class SimpleLUT : MonoBehaviour
    {
        ...
        internal bool Convert(Texture2D lookupTexture)
        {
            if (!SystemInfo.supports3DTextures)
            {
                Console.WriteLine("System does not support 3D textures");
            ...
            else
            {
                ...
                {
                    Console.WriteLine("Lookup texture must not have mipmaps");
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine("Lookup texture dimensions must be a power of two. The height must equal the square root of the width.");
                ...
                {
                    Console.WriteLine("Unable to convert texture to LUT texture, make sure it is read/write. Error: " + ex);
